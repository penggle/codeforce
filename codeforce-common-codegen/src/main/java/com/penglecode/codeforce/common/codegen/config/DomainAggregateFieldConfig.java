...
public class DomainAggregateFieldConfig extends DomainObjectFieldConfig {
    ...
    public DomainAggregateFieldConfig(String fieldName, FullyQualifiedJavaType fieldClass, String fieldTitle, String fieldComment, DomainObjectFieldGroup fieldType, DomainAggregateConfig domainAggregateConfig, DomainAggregateSlaveConfig domainAggregateSlaveConfig) {
