package com.penglecode.codeforce.common.codegen;

import com.penglecode.codeforce.common.codegen.support.CodegenContext;
import com.penglecode.codeforce.common.codegen.support.CodegenFilter;
...
import com.penglecode.codeforce.common.util.FileUtils;
...
public abstract class ModuleCodeGenerator<C extends ModuleCodegenConfigProperties> {
	...
	protected C loadCodegenConfig() {
		try {
			...
			Class<C> codegenConfigPropertiesType = ClassUtils.getSuperGenericType(getClass(), ModuleCodeGenerator.class, 0);
