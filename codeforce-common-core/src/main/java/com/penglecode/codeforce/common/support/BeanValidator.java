...
import com.penglecode.codeforce.common.exception.ApplicationValidationException;
...
public class BeanValidator {
    ...
    private static volatile Validator defaultValidator;
    ...
    private static <T> void checkValidationResults(Set<ConstraintViolation<T>> validationResults) {
    ...
    private static Validator getDefaultValidator() {
        if(defaultValidator == null) {
            synchronized (BeanValidator.class) {
                if(defaultValidator == null) {
                    defaultValidator = SpringUtils.getBean("defaultValidator");
                }
            }
        }
