...
public class FileUtils {
     ...
     * 默认的不推荐使用的文件路径分隔符
     */
    public static final String AGAINST_PATH_DELIMITER = "\\";
    ...
    public static String getFileName(String filePath) {
    	...
    	return filePath.substring(filePath.lastIndexOf(STANDARD_PATH_DELIMITER) + 1);
    }
        ...
        if (!StringUtils.isEmpty(filePath)) {
            ...
            if (Files.isDirectory(path)) {
            	...
            	if(fileName.indexOf('.') == -1) {
            		...
            		return filePath.substring(0, filePath.lastIndexOf(STANDARD_PATH_DELIMITER));
            	}
            }
        }
        return filePath;
     ...
     * @return
     */
    public static boolean deleteFileQuietly(String fullPath) {
        try {
			File file = getFile(fullPath);
			if(file.exists()){
				return file.delete();
