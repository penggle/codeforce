...
public class ProductModuleMapperTest {
    ...
    public void queryProduct() {
        ...
        System.out.println("-----------------------------------------");
        ProductSaleStock productStock = productSaleStockMapper.selectById(new ID().addKey("productId", productId).addKey("specNo", "01:10:20"));
    ...
    public void queryProductByPage() {
        ...
        System.out.println("totalCount = " + productSaleStockMapper.selectPageCountByCriteria(criteria));
        System.out.println("--------------------------第1页------------------------");
        List<ProductSaleStock> productStocks1 = productSaleStockMapper.selectPageListByCriteria(criteria, new RowBounds(0, 10));
        ...
        List<ProductSaleStock> productStocks2 = productSaleStockMapper.selectPageListByCriteria(criteria, new RowBounds(10, 10), new QueryColumns(ProductSaleStock::getProductId, ProductSaleStock::getSpecNo, ProductSaleStock::getSellPrice, ProductSaleStock::getStock));
