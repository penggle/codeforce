 ...
 * @version 1.0
 */
public class DefaultDalMybatisComponentsBuilder extends DalMybatisComponentsBuilder {
    ...
    public SqlSessionFactoryBean buildSqlSessionFactoryBean(DataSource dataSource, MybatisProperties properties) {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage(StringUtils.defaultString(properties.getTypeAliasesPackage(), org.springframework.util.StringUtils.arrayToCommaDelimitedString(getDefaultBasePackages())));
